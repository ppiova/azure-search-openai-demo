...
def test_chat(sized_page: Page, live_server_url: str):
    ...
    page.goto(live_server_url)
    expect(page).to_have_title("AI Digital Connect - Sunshine Industries")
    expect(page.get_by_role("heading", name="Ask your Questions")).to_be_visible()
    expect(page.get_by_role("button", name="Clear chat")).to_be_disabled()
    expect(page.get_by_role("button", name="Developer settings")).to_be_enabled()

    # Ask a question and wait for the message to appear
    page.get_by_placeholder("Type a new question (e.g. what technologies does Sunshine Industries use in its infractructure?)").click()
...
def test_chat_customization(page: Page, live_server_url: str):
    ...
    # Check initial page state
    page.goto(live_server_url)
    expect(page).to_have_title("AI Digital Connect")
