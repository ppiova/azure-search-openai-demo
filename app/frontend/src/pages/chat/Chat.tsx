...
import { Chat12Filled, ChatAddRegular, ChatBubblesQuestionRegular, SparkleFilled } from "@fluentui/react-icons";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <ChatBubblesQuestionRegular fontSize={"80px"} primaryFill={"rgba(81, 88, 102, 1)"} aria-hidden="true" aria-label="Chat logo" />
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. what technologies does Sunshine Industries use in its infrastructure?)"
                            disabled={isLoading}
